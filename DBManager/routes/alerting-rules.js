...
module.exports = (dbManager) => {
  ...
  router.put("/:id", async (req, res) => {
    ...
    try {
      const result = await dbManager.updateAlertingRule(id, req.body);
