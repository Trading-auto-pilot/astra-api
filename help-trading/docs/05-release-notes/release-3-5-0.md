---
sidebar_position: 1
title: Release 3.5.1 - 10/03/2026
---
...
| --- | --- | --- | --- |
| `alertingService` | `2.1.2` | `10/03/2026` | v.2.1.2 Fix Data ultimo run |
...
| `decision-engine` | `2.0.2` | `08/03/2026` | v.2.0.2 Fix entry on Pullback |
...
| `ibkr-login-desktop` | `1.0.0` | `08/03/2026` | Nessuna modifica in questa release |
