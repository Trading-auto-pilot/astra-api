...
// =========================================================
const MICROSERVICE    = "alertingService";
...
class AlertingService {
  ...
  async reloadAlertingRules() {
    if (!this.ruleEngine?.reloadRules) {
      return { ok: false, error: "rule engine not initialized" };
    }
    return this.ruleEngine.reloadRules();
  }
