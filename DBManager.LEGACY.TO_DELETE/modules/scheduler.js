  ...
  try {
    ...
    const [resJob] = await conn.query(
      `INSERT INTO scheduler_jobs
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        payload.jobKey ?? payload.job_key,
        ...
        payload.timeoutMs ?? payload.timeout_ms ?? 15000,
        retry.maxAttempts ?? retry.retry_max_attempts ?? 1,
        retry.backoffMs ?? retry.backoff_ms ?? 5000,
